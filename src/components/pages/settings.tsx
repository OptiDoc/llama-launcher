  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <Card className="p-4">
        <CardHeader className="p-0 mb-3">
          <CardTitle className="flex items-center gap-2 text-[13px]">
            <span className="text-primary"><FolderOpen className="size-4" /></span>
            Paths
          </CardTitle>
        ...
        <CardContent className="p-0 space-y-3">
          <FieldRow id="g-llama-cpp-path" label="llama.cpp binary" hint="Path to the llama-server executable">
            <Input id="g-llama-cpp-path" value={g.llamaCppPath}
              onChange={(e) => update({ llamaCppPath: e.target.value })} className="font-mono text-xs h-8" />
          </FieldRow>
          <FieldRow id="g-models-dir" label="Models directory" hint="Where to look for .gguf files">
            <Input id="g-models-dir" value={g.modelsDir}
              onChange={(e) => update({ modelsDir: e.target.value })} className="font-mono text-xs h-8" />
          </FieldRow>
          <FieldRow id="g-cuda-libs" label="CUDA libraries"
            ...
            <Input id="g-cuda-libs" value={g.cudaLibsDir}
              onChange={(e) => update({ cudaLibsDir: e.target.value })} className="font-mono text-xs h-8" />
          </FieldRow>
        </CardContent>
      </Card>
      ...
      <Card className="p-4">
        <CardHeader className="p-0 mb-3">
          <CardTitle className="flex items-center gap-2 text-[13px]">
            <span className="text-primary"><Network className="size-4" /></span>
            Network
          </CardTitle>
        ...
        <CardContent className="p-0 space-y-3">
          <FieldRow id="g-host" label="Default host" hint="Bind address for new instances">
            <Input id="g-host" value={g.defaultHost}
              onChange={(e) => update({ defaultHost: e.target.value })} className="font-mono text-xs h-8" />
          </FieldRow>
          <div className="grid gap-4 sm:grid-cols-2">
            <FieldRow id="g-port-start" label="Port range start" hint="Auto-allocated from">
              <Input id="g-port-start" type="number" value={g.portRangeStart}
                onChange={(e) => setNum("portRangeStart", e.target.value)} className="font-mono text-xs h-8" />
            </FieldRow>
            <FieldRow id="g-port-end" label="Port range end" hint="Inclusive upper bound">
              <Input id="g-port-end" type="number" value={g.portRangeEnd}
                onChange={(e) => setNum("portRangeEnd", e.target.value)} className="font-mono text-xs h-8" />
            </FieldRow>
          </div>
      ...
      <Card className="p-4 lg:col-span-2">
        <CardHeader className="p-0 mb-3">
          <CardTitle className="flex items-center gap-2 text-[13px]">
            <span className="text-primary"><Bell className="size-4" /></span>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="grid gap-1.5 sm:grid-cols-[160px_1fr] sm:items-center sm:gap-4">
              ...
              <Select value={g.releaseChannel}
                ...
                <SelectTrigger id="g-release-channel" className="w-full h-8"><SelectValue /></SelectTrigger>
                <SelectContent>
      ...
      <Card className="p-4 lg:col-span-2">
        <CardHeader className="p-0 mb-3">
          <CardTitle className="flex items-center gap-2 text-[13px]">
            <span className="text-primary"><Info className="size-4" /></span>
            About
          </CardTitle>
        </CardHeader>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-4">
          <CardHeader className="p-0 mb-3">
            <CardTitle className="flex items-center gap-2 text-[13px]">
              <span className="text-primary"><SettingsIcon className="size-4" /></span>
              Workspace identity
            </CardTitle>
          ...
          <CardContent className="p-0 space-y-3">
            <FieldRow id="ws-name" label="Name" hint="Display name in the sidebar">
              <Input id="ws-name" value={active.name} className="h-8"
          ...
          <CardContent className="p-0 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Input id="ws-hib-input" type="number" min={0} max={600} step={5}
                ...
                onChange={(e) => setWsNum("hibernateAfterSec", e.target.value)} className="font-mono text-sm h-8" />
            </div>
            <Slider
        ...
        <Card className="p-4">
          <CardHeader className="p-0 mb-3">
            <CardTitle className="flex items-center gap-2 text-[13px]">
              <span className="text-primary"><Cpu className="size-4" /></span>
              Defaults
            </CardTitle>
          ...
          <CardContent className="p-0 space-y-3">
            <div className="grid gap-4 sm:grid-cols-2">
              <FieldRow id="ws-gpu-layers" label="GPU layers" hint="Default -ngl">
                <Input id="ws-gpu-layers" type="number" min={0}
                  ...
                  onChange={(e) => setWsNum("defaultGpuLayers", e.target.value)} className="font-mono text-sm h-8" />
              </FieldRow>
              <FieldRow id="ws-threads" label="Threads" hint="Default -t">
                <Input id="ws-threads" type="number" min={1}
                  value={wsSettings.defaultThreads}
                  onChange={(e) => setWsNum("defaultThreads", e.target.value)} className="font-mono text-sm h-8" />
              </FieldRow>
            </div>
            <FieldRow id="ws-max-instances" label="Max concurrent instances" hint="Upper bound for running instances">
              <Input id="ws-max-instances" type="number" min={1}
                ...
                onChange={(e) => setWsNum("maxConcurrentInstances", e.target.value)} className="font-mono text-sm h-8" />
            </FieldRow>
        ...
        <Card className="p-4">
          <CardHeader className="p-0 mb-3">
            <CardTitle className="flex items-center gap-2 text-[13px]">
              <span className="text-primary"><Boxes className="size-4" /></span>
              Workspace resources
            </CardTitle>
