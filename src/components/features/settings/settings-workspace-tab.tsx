...
import {
  Settings as SettingsIcon, Plus, Cpu, Boxes,
} from "lucide-react";
          ...
          <CardContent className="p-0 space-y-3">
            <div className="grid gap-4 sm:grid-cols-2">
              <FieldRow id="ws-gpu-layers" label="GPU layers" hint="Default -ngl">
                <Input id="ws-gpu-layers" type="number" min={0}
                  ...
                  onChange={(e) => setWsNum("default_gpu_layers", e.target.value)} className="font-mono text-sm h-8" />
              </FieldRow>
              <FieldRow id="ws-threads" label="Threads" hint="Default -t">
                <Input id="ws-threads" type="number" min={1}
                  value={wsSettings.default_threads}
                  onChange={(e) => setWsNum("default_threads", e.target.value)} className="font-mono text-sm h-8" />
              </FieldRow>
            </div>
            <FieldRow id="ws-max-instances" label="Max concurrent instances" hint="Upper bound for running instances">
              <Input id="ws-max-instances" type="number" min={1}
                ...
                onChange={(e) => setWsNum("max_concurrent_instances", e.target.value)} className="font-mono text-sm h-8" />
            </FieldRow>
