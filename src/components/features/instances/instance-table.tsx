              ...
              >
                <TableCell className="pl-4 py-3">
                  <div className="flex items-center gap-2.5">
                    <span
                      className={cn("size-2 rounded-full", COLOR_DOT[inst.color])}
                    />
                    <span className="font-medium">{inst.name}</span>
                  </div>
                </TableCell>
                <TableCell className="max-w-[220px] truncate py-3 text-foreground/70">
                  {inst.model}
                </TableCell>
                ...
                <TableCell className="py-3 text-xs text-foreground/70">
                  {uptimeString(inst.startedAt)}
                </TableCell>
                <TableCell className="py-3 text-right font-mono text-xs">
                  {inst.tokensPerSec.toFixed(1)}
                </TableCell>
                <TableCell className="py-3 text-right font-mono text-xs">
                  {inst.requestsPerMin}
                </TableCell>
