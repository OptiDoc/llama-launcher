...
export function createSystemSlice(
  ...
  return {
    tauriReady: false,
    systemCapabilities: {
      gpu_name: "", gpu_vram_gb: 0, gpu_vendor: "none", ram_gb: 0, cpu_name: "", cpu_cores: 0,
      has_cuda: false, has_vulkan: false, has_metal: false, has_rocm: false, disk_free_gb: 0, os_name: "",
    },
    appStatus: "active",
