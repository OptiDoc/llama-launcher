...
const followup2 = await conversation.askFollowUp("What examples were used to illustrate these concepts?");
```
...
const videos = ["https://example.com/video1.mp4", "https://example.com/video2.mp4", "https://example.com/video3.mp4"];
